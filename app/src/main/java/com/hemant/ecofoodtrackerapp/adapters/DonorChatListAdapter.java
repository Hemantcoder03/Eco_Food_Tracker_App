...
public class DonorChatListAdapter extends FirestoreRecyclerAdapter<ChatroomModel, DonorChatListAdapter.MyViewHolder> {
    ...
    protected void onBindViewHolder(@NonNull MyViewHolder holder, int position, @NonNull ChatroomModel model) {
        ...
        //check whether chat with current donor or not
        if (model.getUserIds().get(1).equals(FirebaseUtil.getCurrentUserId()) && !model.getChatroomId().isEmpty()) {
            ...
            query.get().addOnSuccessListener(v -> {
                        ...
                        if (messageModel.get(0) != null) {
                            ...
                            FirebaseUtil.getUserDetails(model.getUserIds().get(0)).get().addOnSuccessListener(v1 -> {
                                        ...
                                        if (userDataModel != null) {
                                            ...
                                            android.icu.text.SimpleDateFormat format = new SimpleDateFormat("dd MMM yyyy");
                                            ...
                                            holder.userChatItem.setOnClickListener(v3 -> {
                                                ...
                                                Intent intent = new Intent(context, DonorMainChatActivity.class);
