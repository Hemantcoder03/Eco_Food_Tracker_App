...
public class CartAdapter extends FirestoreRecyclerAdapter<CartModel, CartAdapter.MyViewHolder> {
    ...
    public CartAdapter(@NonNull FirestoreRecyclerOptions<CartModel> options, Context context) {
        super(options);
    ...
    protected void onBindViewHolder(@NonNull MyViewHolder holder, int i, @NonNull CartModel model) {
        ...
        //first check is there data is present
        if (model.getCartFoodId() == null) {
            AndroidUtil.setToast(context, "No Data Found");
            return;
        }
                        ...
                        try{
                            FirebaseUtil.getCurrentUserDetails().get().addOnSuccessListener(v1 -> {
                                        ...
                                        if(userDataModel != null){
                                            ...
                                            LocationModel locationModel = foodDataModel.getItemDonorNearbyLoc();
